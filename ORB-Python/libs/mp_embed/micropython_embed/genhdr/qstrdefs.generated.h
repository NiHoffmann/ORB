...
QDEF1(MP_QSTR_Analog, 60111, 6, "Analog")
QDEF1(MP_QSTR_B1, 29430, 2, "B1")
QDEF1(MP_QSTR_B10, 53638, 3, "B10")
QDEF1(MP_QSTR_B11, 53639, 3, "B11")
QDEF1(MP_QSTR_B12, 53636, 3, "B12")
QDEF1(MP_QSTR_B2, 29429, 2, "B2")
QDEF1(MP_QSTR_B3, 29428, 2, "B3")
QDEF1(MP_QSTR_B4, 29427, 2, "B4")
QDEF1(MP_QSTR_B5, 29426, 2, "B5")
QDEF1(MP_QSTR_B6, 29425, 2, "B6")
QDEF1(MP_QSTR_B7, 29424, 2, "B7")
QDEF1(MP_QSTR_B8, 29439, 2, "B8")
QDEF1(MP_QSTR_B9, 29438, 2, "B9")
QDEF1(MP_QSTR_BRAKE_MODE, 4518, 10, "BRAKE_MODE")
QDEF1(MP_QSTR_C1, 29335, 2, "C1")
QDEF1(MP_QSTR_EV3Touch, 16480, 8, "EV3Touch")
QDEF1(MP_QSTR_EV3Ultrasonic, 35171, 13, "EV3Ultrasonic")
QDEF1(MP_QSTR_FORWARD, 64894, 7, "FORWARD")
QDEF1(MP_QSTR_I2C, 57181, 3, "I2C")
QDEF1(MP_QSTR_Key_Constants, 48256, 13, "Key_Constants")
QDEF1(MP_QSTR_M1, 29401, 2, "M1")
QDEF1(MP_QSTR_M2, 29402, 2, "M2")
QDEF1(MP_QSTR_M3, 29403, 2, "M3")
QDEF1(MP_QSTR_M4, 29404, 2, "M4")
QDEF1(MP_QSTR_MOVETO_MODE, 9587, 11, "MOVETO_MODE")
QDEF1(MP_QSTR_NO_KEY, 58252, 6, "NO_KEY")
QDEF1(MP_QSTR_POWER_MODE, 31046, 10, "POWER_MODE")
QDEF1(MP_QSTR_REVERSE, 23941, 7, "REVERSE")
QDEF1(MP_QSTR_S1, 29831, 2, "S1")
QDEF1(MP_QSTR_S2, 29828, 2, "S2")
QDEF1(MP_QSTR_S3, 29829, 2, "S3")
QDEF1(MP_QSTR_S4, 29826, 2, "S4")
QDEF1(MP_QSTR_SPEED_MODE, 5118, 10, "SPEED_MODE")
QDEF1(MP_QSTR_TOF, 88, 3, "TOF")
QDEF1(MP_QSTR_Touch, 18080, 5, "Touch")
...
QDEF1(MP_QSTR_acc, 13156, 3, "acc")
QDEF1(MP_QSTR_angle, 11396, 5, "angle")
QDEF1(MP_QSTR_bin, 18656, 3, "bin")
QDEF1(MP_QSTR_bound_method, 41623, 12, "bound_method")
QDEF1(MP_QSTR_brake, 60346, 5, "brake")
QDEF1(MP_QSTR_button, 24819, 6, "button")
QDEF1(MP_QSTR_clearMemory, 65117, 11, "clearMemory")
...
QDEF1(MP_QSTR_devices, 64174, 7, "devices")
QDEF1(MP_QSTR_dict_view, 43309, 9, "dict_view")
QDEF1(MP_QSTR_direction, 29728, 9, "direction")
...
QDEF1(MP_QSTR_getDigital, 17385, 10, "getDigital")
QDEF1(MP_QSTR_getKey, 29732, 6, "getKey")
QDEF1(MP_QSTR_getMemory, 36946, 9, "getMemory")
QDEF1(MP_QSTR_getPosition, 62794, 11, "getPosition")
QDEF1(MP_QSTR_getPower, 2892, 8, "getPower")
QDEF1(MP_QSTR_getSpeed, 19572, 8, "getSpeed")
QDEF1(MP_QSTR_getTime, 53542, 7, "getTime")
QDEF1(MP_QSTR_getValueExt, 53777, 11, "getValueExt")
...
QDEF1(MP_QSTR_ki, 28647, 2, "ki")
QDEF1(MP_QSTR_kp, 28670, 2, "kp")
...
QDEF1(MP_QSTR_mem_offset, 38834, 10, "mem_offset")
...
QDEF1(MP_QSTR_monitor_keys, 15634, 12, "monitor_keys")
QDEF1(MP_QSTR_motor, 2510, 5, "motor")
...
QDEF1(MP_QSTR_setMemory, 19782, 9, "setMemory")
QDEF1(MP_QSTR_setText, 6106, 7, "setText")
QDEF1(MP_QSTR_simple_sensor, 18530, 13, "simple_sensor")
QDEF1(MP_QSTR_speed, 3938, 5, "speed")
QDEF1(MP_QSTR_ticks, 2115, 5, "ticks")
